...
p1 <- ggplot(rus, aes(X, Russia)) + 
  ...
  theme(
    ...
    plot.margin = unit(c(50, 10, 40, 10), "pt")) 
...
# Add texts
# Labels grob
left.title = textGrob("Off the rich list", x = 0, y = 0.9, just = c("left", "top"), 
                      gp = gpar(fontsize = 18, fontfamily = "ITCOfficinaSans LT Book", fontface = "bold"))
labs.title = gTree("LabsTitle", children = gList(left.title))

left.sub = textGrob("Russian billionaires", x = 0, y = 0.9, just = c("left", "top"), 
                    gp = gpar(fontsize = 14, fontfamily = "ITCOfficinaSans LT Book"))
...
left.foot.1 = textGrob("Source: \"Russia's Billionaires\",", x = 0, y = 0.8, just = c("left", "top"), 
                       gp = gpar(fontsize = 12, fontfamily = "ITCOfficinaSans LT Book"))
labs.foot.1 = gTree("LabsFoot1", children = gList(left.foot.1))

left.foot.2 = textGrob(expression(paste("D.Treisman, ", italic("American Economic Review")," (2016).")), x = 0, y = 0.8, just = c("left", "top"), gp = gpar(fontsize = 12, col =  "black", fontfamily = "ITCOfficinaSans LT Book"))
